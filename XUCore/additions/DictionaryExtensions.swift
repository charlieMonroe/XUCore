...
public extension Dictionary {
	...
	@available(*, deprecated, renamed: "arrayOfDictionaries(forKeyPath:)")
	public func arrayOfDictionariesForKeyPath(_ keyPath: String) -> [XUJSONDictionary]? {
		return self.arrayOfDictionaries(forKeyPaths: keyPath)
	}
	
	@available(*, unavailable, renamed: "arrayOfDictionaries(forKeyPaths:)")
	public func arrayOfDictionariesForKeyPaths(_ keyPaths: String...) -> [XUJSONDictionary]? {
		fatalError()
	}
	
	@available(*, deprecated, renamed: "boolean(forKey:)")
	public func booleanForKey(_ key: Key) -> Bool {
		return self.boolean(forKey: key)
	}
	
	@available(*, deprecated, renamed: "boolean(forKeyPath:)")
	public func booleanForKeyPath(_ keyPath: String) -> Bool {
		return self.boolean(forKeyPath: keyPath)
	}
	
	@available(*, deprecated, renamed: "dictionary(forKeyPath:)")
	public func dictionaryForKeyPath(_ keyPath: String) -> XUJSONDictionary? {
		return self.dictionary(forKeyPath: keyPath)
	}
	
	@available(*, unavailable, renamed: "dictionary(forKeyPaths:)")
	public func dictionaryForKeyPaths(_ keyPaths: String...) -> XUJSONDictionary? {
		fatalError()
	}
	
	@available(*, deprecated, renamed: "double(forKey:)")
	public func doubleForKey(_ key: Key) -> Double {
		return self.double(forKey: key)
	}
	
	@available(*, unavailable, renamed: "firstNonNilValue(forKeyPaths:)")
	...
	@available(*, deprecated, renamed: "firstNonNilValue(forKeyPaths:)")
	public func firstNonNilObjectForKeyPaths(_ keyPaths: String...) -> Any? {
		return self.firstNonNilValue(forKeyPaths: keyPaths)
	}
	
	@available(*, deprecated, renamed: "firstNonNilValue(forKeys:)")
	public func firstNonNilObjectForKeys<T>(_ keys: [Key]) -> T? {
		return self.firstNonNilValue(forKeys: keys)
	}
	
	@available(*, deprecated, renamed: "firstNonNilString(forKeyPaths:)")
	public func firstNonNilStringForKeyPaths(_ keyPaths: [String]) -> String? {
		return self.firstNonNilString(forKeyPaths: keyPaths)
	}
	
	@available(*, unavailable, renamed: "firstNonNilString(forKeyPaths:)")
	public func firstNonNilStringForKeyPaths(_ keyPaths: String...) -> String? {
		fatalError()
	}
	
	@available(*, deprecated, renamed: "firstNonNilString(forKeys:)")
	public func firstNonNilStringForKeys(_ keys: [Key]) -> String? {
		return self.firstNonNilString(forKeys: keys)
	}
	
	@available(*, unavailable, renamed: "firstNonNilString(forKeys:)")
	public func firstNonNilStringForKeys(_ keys: Key...) -> String? {
		fatalError()
	}
	
	@available(*, deprecated, renamed: "integer(forKey:)")
	public func integerForKey(_ key: Key) -> Int {
		return self.integer(forKey: key)
	}
	
	@available(*, deprecated, renamed: "integer(forKeyPath:)")
	public func integerForKeyPath(_ keyPath: String) -> Int {
		return self.integer(forKeyPath: keyPath)
	}
	
	@available(*, deprecated, renamed: "value(forKeyPath:)")
	public func objectForKeyPath(_ keyPath: String) -> Any? {
		return self.value(forKeyPath: keyPath)
	}
	
	@available(*, deprecated, renamed: "string(forKeyPath:)")
	public func stringForKeyPath(_ keyPath: String) -> String? {
		return self.string(forKeyPath: keyPath)
	}
}
